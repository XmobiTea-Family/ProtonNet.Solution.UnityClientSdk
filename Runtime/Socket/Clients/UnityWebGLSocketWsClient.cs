...
namespace XmobiTea.ProtonNet.Client.Socket.Clients
{
    ...
    /// </summary>
    class UnityWebGLSocketWsClient : ISocketClient, ISetEncryptKey
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnityWebGLSocketWsClient"/> class with the specified server address, port, and client options.
        /// </summary>
        /// <param name="address">The server address.</param>
        /// <param name="port">The server port.</param>
        /// <param name="options">The TCP client options.</param>
        public UnityWebGLSocketWsClient(IWebSocketPluginBridgeSupport webSocketPluginBridgeSupport, int id, string address, int port, TcpClientOptions options)
        {
            this.webSocketPluginBridgeSupport = webSocketPluginBridgeSupport;
            this.id = id;
            this.networkStatistics = new ChangeNetworkStatistics();

            var finalAddress = "ws://" + address;
